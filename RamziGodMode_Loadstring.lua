-- Ramzi GodMode Loadstring Executor
-- Copy and paste this entire code into your Roblox executor (Synapse, Krnl, etc.)

loadstring(game:HttpGet("https://raw.githubusercontent.com/aweysamoore903-bot/voxels-roblox-script/main/RamziGodMode.lua"))()

-- Alternative: Direct inline execution
--[[
If the above doesn't work, use this direct execution method:
]]
